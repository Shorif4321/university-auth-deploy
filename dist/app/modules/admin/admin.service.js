...
const updateAdmin = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!isExist) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'The Admin Does Not Exist');
    }
    ...
    if (name && Object.keys(name).length > 0) {
        Object.keys(name).forEach(key => {
            ...
            updatedAdminData[nameKey] = name[key]; // updatedStudentData['guardian.motherContactNo']=name["ALishorif"]
        });
    }
...
const deleteAdmin = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield admin_model_1.Admin.findByIdAndDelete(id).populate('managementDepartment');
    return result;
});
